...
class DigitsDataset(Dataset):
    ## Extract what are the main changes that hve happened here using only 10% of the dataset or something, realize what is happening here and then simulate that stuff
    
    
    ## the only chamges are in self.images and self.labels, there should be no other changes.
